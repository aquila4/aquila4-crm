...
class Property(db.Model):
    ...
    total_plots = db.Column(db.Integer, nullable=False)
...
class Property(db.Model):
    ...
    plots = db.relationship('Plot', back_populates='property')
...
class Plot(db.Model):
    ...
    # MUST MATCH Property.plots
    property = db.relationship('Property', back_populates='plots')